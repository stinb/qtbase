                                 ...
                                 const QWidget *widget) const
{
   ...
   case PE_PanelMenu:
    ...
    case PE_IndicatorTabClose: {
        ...
        QPixmap pixmap = d->tabBarcloseButtonIcon.pixmap(getWindow(widget), QSize(size, size), mode, state);
 ...
 case CE_PushButtonLabel:
        if (const QStyleOptionButton *button = qstyleoption_cast<const QStyleOptionButton *>(opt)) {
            ...
            if (!button->icon.isNull()) {
                ...
                QPixmap pixmap = button->icon.pixmap(getWindow(widget), button->iconSize, mode, state);
    ...
    case CE_MenuBarItem:
        if (const QStyleOptionMenuItem *mbi = qstyleoption_cast<const QStyleOptionMenuItem *>(opt)) {
            ...
            QPixmap pix = mbi->icon.pixmap(getWindow(widget), QSize(iconExtent, iconExtent), (mbi->state & State_Enabled) ? QIcon::Normal : QIcon::Disabled);
            if (!pix.isNull())
    ...
    case CE_HeaderLabel:
        if (const QStyleOptionHeader *header = qstyleoption_cast<const QStyleOptionHeader *>(opt)) {
            ...
            if (!header->icon.isNull()) {
                int iconExtent = proxy()->pixelMetric(PM_SmallIconSize);
                QPixmap pixmap
                    = header->icon.pixmap(getWindow(widget), QSize(iconExtent, iconExtent), (header->state & State_Enabled) ? QIcon::Normal : QIcon::Disabled);
            ...
            if (((!hasArrow && toolbutton->icon.isNull()) && !toolbutton->text.isEmpty())
                ...
                if (!toolbutton->icon.isNull()) {
                    ...
                    if (!(toolbutton->state & State_Enabled))
                        ...
                        mode = QIcon::Normal;
                    pm = toolbutton->icon.pixmap(getWindow(widget), toolbutton->rect.size().boundedTo(toolbutton->iconSize),
                                                 mode, state);
    ...
    case CE_ToolBoxTabLabel:
        if (const QStyleOptionToolBox *tb = qstyleoption_cast<const QStyleOptionToolBox *>(opt)) {
            ...
            QPixmap pm = tb->icon.pixmap(getWindow(widget), QSize(iconExtent, iconExtent),
    ...
    case CE_TabBarTabLabel:
        if (const QStyleOptionTab *tab = qstyleoption_cast<const QStyleOptionTab *>(opt)) {
            ...
            if (!tabV2.icon.isNull()) {
                QPixmap tabIcon = tabV2.icon.pixmap(getWindow(widget), tabV2.iconSize,
        ...
        if (const QStyleOptionComboBox *cb = qstyleoption_cast<const QStyleOptionComboBox *>(opt)) {
            ...
            if (!cb->currentIcon.isNull()) {
                QIcon::Mode mode = cb->state & State_Enabled ? QIcon::Normal
                                                             : QIcon::Disabled;
                QPixmap pixmap = cb->currentIcon.pixmap(getWindow(widget), cb->iconSize, mode);
    ...
    case CE_ItemViewItem:
        if (const QStyleOptionViewItem *vopt = qstyleoption_cast<const QStyleOptionViewItem *>(opt)) {
            ...
            QSize size = vopt->icon.actualSize(getWindow(widget), iconRect.size(), mode, state);
            QRect rect = alignedRect(p->layoutDirection(), vopt->decorationAlignment, size, iconRect);
            p->drawPixmap(rect, vopt->icon.pixmap(getWindow(widget), size, mode, state));
        ...
        if (const QStyleOptionButton *btn = qstyleoption_cast<const QStyleOptionButton *>(opt)) {
            ...
            if (!btn->icon.isNull()) {
                iconRect = itemPixmapRect(cr, Qt::AlignAbsolute | Qt::AlignLeft | Qt::AlignVCenter
                                        | Qt::TextShowMnemonic,
                                   btn->icon.pixmap(getWindow(widget), btn->iconSize, QIcon::Normal));
                if (!textRect.isEmpty())
        ...
        if (const QStyleOptionTitleBar *tb = qstyleoption_cast<const QStyleOptionTitleBar *>(opt)) {
            ...
            if (tb->subControls & SC_TitleBarCloseButton && tb->titleBarFlags & Qt::WindowSystemMenuHint) {
                ...
                if ((tb->titleBarFlags & Qt::WindowType_Mask) == Qt::Tool
                    ...
                    pm = proxy()->standardIcon(SP_DockWidgetCloseButton, &tool, widget).pixmap(getWindow(widget), QSize(10, 10));
                else
                    pm = proxy()->standardIcon(SP_TitleBarCloseButton, &tool, widget).pixmap(getWindow(widget), QSize(10, 10));
                tool.rect = ir;
            ...
            if (tb->subControls & SC_TitleBarMaxButton
                ...
                pm = proxy()->standardIcon(SP_TitleBarMaxButton, &tool, widget).pixmap(getWindow(widget), QSize(10, 10));
                tool.rect = ir;
                tool.state = down ? State_Sunken : State_Raised;
                proxy()->drawPrimitive(PE_PanelButtonTool, &tool, p, widget);
            ...
            if (tb->subControls & SC_TitleBarMinButton
                ...
                pm = proxy()->standardIcon(SP_TitleBarMinButton, &tool, widget).pixmap(getWindow(widget), QSize(10, 10));
                tool.rect = ir;
                tool.state = down ? State_Sunken : State_Raised;
                proxy()->drawPrimitive(PE_PanelButtonTool, &tool, p, widget);
            ...
            if (drawNormalButton) {
                ...
                pm = proxy()->standardIcon(SP_TitleBarNormalButton, &tool, widget).pixmap(getWindow(widget), QSize(10, 10));
                tool.rect = ir;
                tool.state = down ? State_Sunken : State_Raised;
                proxy()->drawPrimitive(PE_PanelButtonTool, &tool, p, widget);
            ...
            if (tb->subControls & SC_TitleBarShadeButton
                ...
                pm = proxy()->standardIcon(SP_TitleBarShadeButton, &tool, widget).pixmap(getWindow(widget), QSize(10, 10));
                tool.rect = ir;
                tool.state = down ? State_Sunken : State_Raised;
                proxy()->drawPrimitive(PE_PanelButtonTool, &tool, p, widget);
                p->save();
            ...
            if (tb->subControls & SC_TitleBarUnshadeButton
                ...
                pm = proxy()->standardIcon(SP_TitleBarUnshadeButton, &tool, widget).pixmap(getWindow(widget), QSize(10, 10));
                tool.rect = ir;
                tool.state = down ? State_Sunken : State_Raised;
                proxy()->drawPrimitive(PE_PanelButtonTool, &tool, p, widget);
                p->save();
            ...
            if (tb->subControls & SC_TitleBarContextHelpButton
                ...
                pm = proxy()->standardIcon(SP_TitleBarContextHelpButton, &tool, widget).pixmap(getWindow(widget), QSize(10, 10));
                tool.rect = ir;
                tool.state = down ? State_Sunken : State_Raised;
                proxy()->drawPrimitive(PE_PanelButtonTool, &tool, p, widget);
                p->save();
            ...
            if (tb->subControls & SC_TitleBarSysMenu && tb->titleBarFlags & Qt::WindowSystemMenuHint) {
                ...
                if (!tb->icon.isNull()) {
                    ...
                    pm = proxy()->standardIcon(SP_TitleBarMenuButton, &tool, widget).pixmap(getWindow(widget), QSize(iconSize, iconSize));
                    tool.rect = ir;
                    p->save();
                    proxy()->drawItemPixmap(p, ir, Qt::AlignCenter, pm);
                    p->restore();
    ...
    case CC_MdiControls:
        {
            ...
            if (opt->subControls & QStyle::SC_MdiCloseButton) {
                ...
                QPixmap pm = proxy()->standardIcon(SP_TitleBarCloseButton).pixmap(getWindow(widget), QSize(16, 16));
            ...
            if (opt->subControls & QStyle::SC_MdiNormalButton) {
                ...
                proxy()->drawPrimitive(PE_PanelButtonCommand, &btnOpt, p, widget);
                QPixmap pm = proxy()->standardIcon(SP_TitleBarNormalButton).pixmap(getWindow(widget), QSize(16, 16));
                proxy()->drawItemPixmap(p, btnOpt.rect.translated(bsx, bsy), Qt::AlignCenter, pm);
            }
            if (opt->subControls & QStyle::SC_MdiMinButton) {
                ...
                proxy()->drawPrimitive(PE_PanelButtonCommand, &btnOpt, p, widget);
                QPixmap pm = proxy()->standardIcon(SP_TitleBarMinButton).pixmap(getWindow(widget), QSize(16, 16));
                proxy()->drawItemPixmap(p, btnOpt.rect.translated(bsx, bsy), Qt::AlignCenter, pm);
            }
        }
        break;
        ...
        case SP_FileLinkIcon:
            {
                ...
                if (!linkIcon.isNull()) {
                    ...
                    for (int i = 0 ; i < sizes.size() ; ++i) {
                        ...
                        QPixmap basePixmap = baseIcon.pixmap(getWindow(widget), QSize(size, size));
                        QPixmap linkPixmap = linkIcon.pixmap(getWindow(widget), QSize(size / 2, size / 2));
